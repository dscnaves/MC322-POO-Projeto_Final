...
public class Sistema {
    ...
    public void cadastro(String nome, String userName, String senha) throws CadastroInvalidoException {
        ...
        usuarios.add(new Usuario(nome, userName, senha)); // Se user e senha validos cadastramos
        System.out.println("Usuário '" + userName + "' cadastrado com sucesso!\n");
    }

    public void login(String userName, String senha) throws CadastroInvalidoException {
